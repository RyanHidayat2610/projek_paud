...
@section('content')
            ...
            <section class="kegiatan">
                <h2 class="paudd">Kegiatan Kami</h2>
                <div class="kegiatan-gallery">
                    <div class="kegiatan-item">
                        <img src="{{ asset('images/foto1.jpg') }}" alt="Kegiatan 1" onclick="tampilkanGambar(this)" class="popup-img">
                    </div>
                    <div class="kegiatan-item">
                        <img src="{{ asset('images/foto2.jpg') }}" alt="Kegiatan 2" onclick="tampilkanGambar(this)" class="popup-img">
                    </div>
                    <div class="kegiatan-item">
                        <img src="{{ asset('images/foto3.jpg') }}" alt="Kegiatan 3" onclick="tampilkanGambar(this)" class="popup-img">
                    </div>
                    <div class="kegiatan-item">
                        <img src="{{ asset('images/foto5.jpg') }}" alt="Kegiatan 4" onclick="tampilkanGambar(this)" class="popup-img">
                    </div>
                </div>
            </section>
            <!-- Program PAUD Khairani -->
            <section class="program">
                <h2 class="paudd"> Program PAUD AL ATHIRAH</h2>
                <div class="program-cards">
                    <div class="program-card">
                        <div class="program-shape shape-1">
                            <img src="{{ asset('images/foto7.jpg') }}" alt="Belajar Bersama" class="hover-img" onclick="tampilkanGambar(this)" class="popup-img">
                    ...
                    <div class="program-card">
                        <div class="program-shape shape-2" style="background-image: url('makan-bersama.jpg');">
                            <img src="{{ asset('images/foto6.jpg') }}" alt="Mengaji Bersama" class="hover-img" onclick="tampilkanGambar(this)" class="popup-img">
                    ...
                    <div class="program-card">
                        <div class="program-shape shape-3">
                            <img src="{{ asset('images/foto9.jpg') }}" alt="Sholat Bersama" class="hover-img" onclick="tampilkanGambar(this)" class="popup-img">
                    ...
                    <div class="program-shape shape-4">
                        <img src="{{ asset('images/foto3.jpg') }}" alt="Periksa Kesehatan" class="hover-img" onclick="tampilkanGambar(this)" class="popup-img">
                    ...
                    <div class="program-shape shape-5">
                        <img src="{{ asset('images/foto6.jpg') }}" alt="Diskusi Bersama" class="hover-img" onclick="tampilkanGambar(this)" class="popup-img">
                    ...
                    <div class="program-card">
                        <div class="program-shape shape-5">
                            <img src="{{ asset('images/foto8.jpg') }}" alt="Kesenian" class="hover-img" onclick="tampilkanGambar(this)" class="popup-img">
                            <h3>Kesenian</h3>
